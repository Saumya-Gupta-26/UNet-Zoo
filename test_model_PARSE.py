...
---for prob unet, using other codebase

CUDA_VISIBLE_DEVICES=2 python test_model_PARSE.py /home/saumgupta/UNet-Zoo/models/experiments/phiseg_7_5_6_PARSE2D_test.py local
'''
import os
...
from dataloader import PARSE_2D
...
if __name__ == '__main__':
    ...
    test_set = PARSE_2D(exp_config.validation_datalist, exp_config.folders, is_testing= True)
