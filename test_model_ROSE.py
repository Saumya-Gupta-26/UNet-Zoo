...
CUDA_VISIBLE_DEVICES=7 python test_model_ROSE.py /home/saumgupta/UNet-Zoo/models/experiments/prob_unet_ROSE_test.py local
CUDA_VISIBLE_DEVICES=7 python test_model_ROSE.py /home/saumgupta/UNet-Zoo/models/experiments/phiseg_7_5_6_ROSE_test.py local
'''
import os
...
from dataloader import ROSE_folder
import shutil
...
if __name__ == '__main__':
    ...
    test_set = ROSE_folder(exp_config.train_datalist, exp_config.folders)
